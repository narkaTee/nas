# from https://github.com/tomeon/ansible-connection-machinectl
...
# Permalink: https://github.com/ansible/ansible/blob/a9d5bf717c200126c46433de1a833f2dd34397f6/lib/ansible/plugins/connection/ssh.py#L332-L340
#
# additional inspirtation: https://github.com/ansible-collections/community.general/blob/main/plugins/connection/lxc.py
...
class Connection(ConnectionBase):
    ...
    def exec_command(self, cmd, in_data=None, sudoable=False):
        ...
        return self._run_command('shell', opts=opts, args=shlex.split(cmd),
                                          machine=self.machine)

        # it looks like this is mostly copy pasted and adjusted from the ssh connection plugin
        # I think this is not needed and can be replaced with _run_command.
        # There is no complex connection initialization and interactive login prompt
